(function($) {
  ...
  $.imageCrop = function(object, customOptions) { 
    ...
    function updateOverlayLayer() {
      $overlay.css({
        display: selectioinExists ? 'block' : 'none'
      });
    };
    ...
    function setSelection(event) {
      ...
      // Notifiy that a selection exists
      selectionExists = true;
  ...
  $.fn.imageCrop = function(customOptions) {
    ...
    this.each(function() {
      ...
      image.onload = function() {
        $.imageCrop(currentObject, customOption);
      };
      
      // Reset the src because cached images dont fire load sometimes
